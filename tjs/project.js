...
(function(jq){
	...
	var body = jq(w_document.body);

	var dm5_tools = new function(){
		var c_title, c_charpter, c_next_url, c_key, c_list, auto_loading_flag = '#auto_loading';
		this.ini = function(win){
			addBtn();
		}
